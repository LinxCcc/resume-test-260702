...
export const experiences = [
  {
    ...
    role: '产品经理',
    desc:
      '负责汽车融资租赁直租、回租、库融等产品设计，覆盖租前、租中、租后全生命周期，参与 APP、小程序及中后台系统建设。\n\n熟悉核心业务流程，包括进件、评估、授信、签约、扣款、报销、客户服务及资产处置，具备复杂业务流程梳理、系统方案设计、交互设计及产品落地能力。\n\n围绕客户、业务人员等多角色场景，优化产品流程与系统体验，推动业务标准化和运营效率提升。\n'
  },
  {
  ...
  },
  {
    ...
    role: '产品设计主管',
    desc:
      '负责社交娱乐类移动 APP 产品体验设计及团队管理，覆盖秀场直播、社交互动、新产品孵化等业务方向。\n\n参与多款产品 0-1 孵化及版本迭代，围绕用户体验、内容消费、互动玩法和商业化场景，负责产品流程、交互方案及体验优化。\n\n深入参与虚拟礼物、互动玩法、运营活动等商业化建设，提升用户参与体验，助力业务增长；负责设计团队管理及规范体系建设，提升协作效率与交付质量。'
  },
  {
